...
private getGroupName(id) {
    switch (id) {
      case null: return 'Home'
      case '0b2fcf36-a4ab-4f49-820f-14d4c46891a0': return 'Back Porch'
      case '0dca73ca-3ddc-4c2b-846f-70f22f45abb3': return 'Kitchen'
      case '12b68a62-7363-4cef-a404-83477b80e493': return 'Cat Room'
      case '365bab81-8f58-417f-bc34-ecd7f2518f8c': return 'Pantry'
      case '39144834-f1bf-40e0-a23e-c1d351a50fc7': return 'Living Room'
      case '3c569da2-8a3e-4af3-b7ab-fce3bbc761ab': return 'Laundry Room'
      case '43bcadc9-a78f-49f5-a1ed-9c6156f7f013': return 'Dining Room'
      case '7a961b42-9ca0-4262-b753-a71aafaac2de': return 'Front Porch'
      case '90bb7618-491e-4153-9ba7-58c973589d4d': return "Jason's Room"
      case '9bddfcfe-47a0-444f-811c-32f31ad54c43': return 'Great Room'
      case 'ab0ae1e0-d5ce-4817-bc17-d28e6bc8bb1f': return 'Exercise Room'
      case 'cf79c7af-df49-49f1-839c-06a1fa13cf67': return "Michelle's Room"
      case 'ea276e4b-1b20-47d8-8aa1-c0c14d58edd5': return 'Office'
      case 'eae4e2d0-0896-4a6b-8605-53085fa7adcc': return "Jason's Bathroom"
      case 'ec4da116-2ba9-4021-872c-546ac070a7d3': return 'Garage'
      case '183aa05a-7d14-4613-94bc-5e7c36f56895': return 'Hallway'
      case '4bbf6cd5-a710-48d5-af86-d5469d25c513': return 'Buttons'
